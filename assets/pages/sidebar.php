...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;height: calc(100vh - 65px);">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        <li><a class="dropdown-item" href="#" dideo-checked="true">New project...</a></li>
        <li><a class="dropdown-item" href="#" dideo-checked="true">Settings</a></li>
        <li><a class="dropdown-item" href="#" dideo-checked="true">Profile</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="#" dideo-checked="true">Sign out</a></li>
      </ul>
    </div>
  </div>
